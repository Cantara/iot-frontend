...
public class IotFrontendApplication extends Application<IotFrontendDropwizardConfiguration> {
    ...
    public void initialize(Bootstrap<IotFrontendDropwizardConfiguration> bootstrap) {
        ...
        bootstrap.addBundle(new AssetsBundle("/assets/subscription.html","/frontend/subscription","subscription.html", "subscription"));
        bootstrap.addBundle(new AssetsBundle("/assets/index.html","/frontend/","index.html"));
        bootstrap.addBundle(new AssetsBundle("/assets/css", "/frontend/css", null, "css"));
        bootstrap.addBundle(new AssetsBundle("/assets/js", "/frontend/js", null, "js"));
        bootstrap.addBundle(new AssetsBundle("/assets/fonts", "/frontend/fonts", null, "fonts"));
        bootstrap.addBundle(new AssetsBundle("/assets/images", "/frontend/images", null, "images"));
